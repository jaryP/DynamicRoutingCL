...
;;
scaler)
  python main.py +scenario=cil_cifar100_10 model=$MODEL +training=cifar100 +method=margin device=$DEVICE method.mem_size=1000 method.past_task_reg=0.25 method.gamma=1 hydra=search +wadnb_tags=[margin_scale_ablation] head=margin_head +head.scale=False experiment=base2
;;
future)
