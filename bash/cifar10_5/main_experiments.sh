...
;;
der)
  python main.py +scenario=cil_cifar10_rp +model="$MODEL" +training=cifar10_5 +method=der_200 optimizer=adam device=$DEVICE +model.head_classes=100 method.alpha=0.2 method.beta=1
  python main.py +scenario=cil_cifar10_rp +model="$MODEL" +training=cifar10_5 +method=der_500 optimizer=adam device=$DEVICE +model.head_classes=100 method.alpha=0.2 method.beta=0.8
  python main.py +scenario=cil_cifar10_rp +model="$MODEL" +training=cifar10_5 +method=der_1000 optimizer=adam device=$DEVICE +model.head_classes=100 method.alpha=0.1 method.beta=0.8
  python main.py +scenario=cil_cifar10_rp +model="$MODEL" +training=cifar10_5 +method=der_2000 optimizer=adam device=$DEVICE +model.head_classes=100 method.alpha=0.1 method.beta=1
;;
routing)
  python main.py +scenario=cil_cifar10_rp +model=routing_5l_convblock_p +training=cifar10_5 +method=routing_cifar10 optimizer=adam device=$DEVICE method.past_task_reg=0.01 method.past_margin=1 method.gamma=1
  python main.py +scenario=cil_cifar10_rp +model=routing_5l_convblock_p +training=cifar10_5 +method=routing_cifar10 optimizer=adam device=$DEVICE method.past_task_reg=0.01 method.past_margin=0.3 method.mem_size=500 method.gamma=1
  python main.py +scenario=cil_cifar10_rp +model=routing_5l_convblock_p +training=cifar10_5 +method=routing_cifar10 optimizer=adam device=$DEVICE method.past_task_reg=0.01 method.past_margin=0.3 method.mem_size=1000 method.gamma=1
  python main.py +scenario=cil_cifar10_rp +model=routing_5l_convblock_p +training=cifar10_5 +method=routing_cifar10 optimizer=adam device=$DEVICE method.past_task_reg=0.1 method.past_margin=1 method.mem_size=2000 method.gamma=1
;;
#cope)
