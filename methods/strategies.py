...
# from avalanche.training.plugins import SupervisedTemplate, EvaluationPlugin
...
class EmbeddingRegularization(SupervisedTemplate):
...
class CustomEWC(SupervisedTemplate):
